...
//Select WALL Button
var btnsetwall = document.getElementById("wallbtn");
btnsetwall.addEventListener("click", setwallheight);

//SETING Wall Height
wallHeight = document.getElementById("wallinput").value;
function setwallheight(wallHeight) {
